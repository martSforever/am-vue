<template>
    <div class="index-example-nav-menu">
        <div v-for="(item,index) in urls" :key="index" class="menu-item" @click="handleClick(item)"
...
<script>
    export default {
        ...
        mounted() {
            this.currentUrl = this.$router.history.current.path.slice(1);
        },
    };
</script>
